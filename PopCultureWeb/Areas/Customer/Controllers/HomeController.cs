...
namespace PopCultureWeb.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "Category,WearType");
        ...
        public IActionResult Details(int productId)
        {
            ShoppingCart cartObj = new()
            {
                Count = 1,
                ProductId = productId,
                Product = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == productId, includeProperties: "Category,WearType")
            };
